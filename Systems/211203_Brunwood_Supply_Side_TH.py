...
def fab_name(Name):
    ...
    _Airtightness=re.split('Airtightness.',Code[4])[1]
    Fab_dict={"Wall":_Wall,"Roof":_Roof,"Groud Floor":_Ground_Floor,"Glazing":_Glazing,"Airtightness":_Airtightness}
    print(Fab_dict)
    return(Fab_dict)
...
#Post Processed Fans Load 
Total_Plot['Annual Fan Power Load(kWh/m2)']=Fan_Power(Baseline_SFP,Model_Mass_Flow,GrossFloorArea)
...
def Supply_Side(Demand,SEL_Heat_Cool,SEL_DHW,SEL_Light,SEL_Light_CON,SEL_Equip,SEL_Vent,SEL_Renew):
    ...
    Vent_Energy=Fan_Power(Perm_Vent['Eff']['SPF'],Perm_Demand['Annual Fan Power Load(kWh/m2)'],GrossFloorArea)
...
FFP=r'C:\\Users\\JTHOM\\OneDrive - Ramboll\\Documents\\GitHub\\Bruntwood_V1\\data\\57b120e6-0e92-4ccd-b290-464769b02f7f\\Results_TH.feather'
